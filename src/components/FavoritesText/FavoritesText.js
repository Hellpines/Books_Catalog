import './FavoritesText.css';

export const createFavoritesText = (count = 0) => {
    const favoritesTextContainer = document.createElement('div');

    favoritesTextContainer.className = 'favoritesTextContainer';

    favoritesTextContainer.innerHTML = `
        ...
        <div class='favoritesText'>
            <h2>Favorites</h2>
            <p>${count} books saved</p>
        </div>
    `;

    return favoritesTextContainer;
};